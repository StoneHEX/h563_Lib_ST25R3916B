...
#define PLATFORM_LED_ERROR_PIN		LED3_RED_Pin          /*!< GPIO pin used as error LED */
#define PLATFORM_LED_ERROR_PORT     LED3_RED_GPIO_Port    /*!< GPIO port used as error LED*/
#define PLATFORM_LED_NOCARD_PIN		LED2_YELLOW_Pin       /*!< GPIO pin used as error LED */
#define PLATFORM_LED_NOCARD_PORT    LED2_YELLOW_GPIO_Port /*!< GPIO port used as error LED*/
#define PLATFORM_LED_CARDFOUND_PIN	LED1_GREEN_Pin        /*!< GPIO pin used as error LED */
#define PLATFORM_LED_CARDFOUND_PORT LED1_GREEN_GPIO_Port  /*!< GPIO port used as error LED*/
